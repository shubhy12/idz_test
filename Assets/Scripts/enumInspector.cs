...
{
    public enum MoveTypeEnum { AutoMove, Waypoints };
...
public class enumInspectorEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        //Enum drop down
        enumScript.moveType = (enumInspector.MoveTypeEnum)EditorGUILayout.EnumPopup(enumScript.moveType);
        //switch statement for different variables
        switch (enumScript.moveType)
        {
            //AutoMove
            case enumInspector.MoveTypeEnum.AutoMove:
                ...
                break;
            //waypoint
            case enumInspector.MoveTypeEnum.Waypoints:
